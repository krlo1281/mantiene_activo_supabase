    ...
    useEffect(() => {
        if (companyToEdit) {
            setFormData({
                ...
                portalStatus: companyToEdit.portalStatus || "INACTIVO",
            })
        } else {
            setFormData({ ruc: "", name: "", address: "", phone: "", email: "", portalStatus: "INACTIVO" })
        }
    }, [companyToEdit, open])
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent>
                ...
                <form onSubmit={handleSubmit} className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="portalStatus">Acceso Portal Clientes</Label>
                        <Select
                            value={formData.portalStatus}
                            onValueChange={(value) => setFormData({ ...formData, portalStatus: value })}
                        >
                            <SelectTrigger id="portalStatus">
