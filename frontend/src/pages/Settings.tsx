            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {saved && <span className="text-green-600 text-sm font-medium animate-pulse">Â¡Guardado correctamente!</span>}
                    </div>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-4">
                        <Button onClick={handleSaveBackground} disabled={!selectedBgPeriod || bgLoading} className="w-full sm:w-auto">
                            {bgLoading ? "Guardando..." : "Guardar Fondo"}
                        </Button>
                        {bgSaved && <span className="text-green-600 text-sm font-medium animate-pulse">Â¡Fondo actualizado!</span>}
                    </div>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                        ...
                        {syncSaved && <span className="text-emerald-600 text-sm font-medium animate-pulse">Â¡Automatización lista!</span>}
                    </div>
                </CardContent>
            </Card>
        </div>
