...
export default function Periods() {
    ...
    const handleDelete = async (id: string) => {
        if (!confirm("Â¿Estás seguro de eliminar este periodo? Esto eliminará todas las asignaciones asociadas.")) return;
        try {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[#0d141b] dark:text-white">Periodos</h2>
                    <p className="text-sm md:text-base text-muted-foreground">Gestión de periodos mensuales de monitoreo.</p>
                </div>
