...
export default function Dosimeters() {
    ...
    const handleDelete = async (id: string) => {
        if (!confirm("Â¿Estás seguro de eliminar este dosímetro?")) return;
        try {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-[#0d141b] dark:text-white">Dosímetros</h2>
                    <p className="text-sm md:text-base text-muted-foreground">Inventario de dosímetros (Película/TLD).</p>
                </div>
                <div className="flex gap-2 w-full md:w-auto">
                    ...
                    <Button onClick={handleCreate} className="gap-2 flex-1 md:flex-none p-2 sm:px-4">
                        <span className="material-symbols-outlined text-sm">add_circle</span>
                        <span className="hidden sm:inline">Nuevo Dosímetro</span>
